...
#include <fenestra/helpers/concepts.hpp>
...
namespace ImGuiExt {
    ...
    inline ImGuiCustomData::Styles& GetCustomStyle() {
        auto &customData = *static_cast<ImGuiCustomData *>(ImGui::GetIO().UserData);
    ...
    constexpr ImGuiDataType getImGuiDataType() {
        ...
        else static_assert(fene::always_false<T>::value, "Invalid data type!");
    }
