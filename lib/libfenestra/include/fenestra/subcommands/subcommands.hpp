...
namespace fene::subcommands {
    ...
    /**
     * @brief Internal method - takes all the arguments the Application received from the command line,
     ...
     * The callback will be executed after EventApplicationStartupFinished
     */
